...
urlpatterns = [
    ...
    path('api/user/', get_user, name='get_user'), #path pour obtenir les informations de l'utilisateur
    ...
    path('api/toggle_2fa/', views.toggle_2fa, name='toggle_2fa'), #switch to enable/disable 2fa
    path('api/change_email/', views.change_email, name='change_email'), #change email
    path('api/logwithoutlogin/', views.logwithoutlogin, name='logwithoutlogin'), #login for tournament
    path('api/game_end_other/', views.game_end_other_view, name='game_end_other'), #path pour recuperer les donnes de fin de partie des autres
    path('api/tournament_end/', views.tournament_end_view, name='tournament_end'), #path pour recuperer les donnes de fin de tournoi
    path('api/oauth2/set-password/', views.oauth2_set_password, name='oauth2_set_password'),
]
