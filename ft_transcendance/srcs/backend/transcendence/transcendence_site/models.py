...
class MyUser(AbstractUser):
    ...
    profil_picture_url = models.URLField(max_length=500, null=True, blank=True)  # Store URL of 42 profile picture
...
class GameStats(models.Model): #class partie historique
    ...
    tournament_players = models.TextField(blank=True, null=True) #store the players of the tournament